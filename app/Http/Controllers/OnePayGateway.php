...
class OnePayGateway extends Controller
{
    ...
    private function onePayGateway($paymentInfo) {
        ...
        "transaction_redirect_url" => "https://dashboard.itranslate.lk/#/app/select-services", // spaces are not allowed
    ...
    private function onePayCallBackResponse(Request $request) {
